...
/*When the sketch executes, you have one minute to set the current time by sending a T followed by the current Unix epoch time to the Arduino, e.g. over the serial monitor. E.g. T1704284920
 * Get the current epoch here: https://www.epochconverter.com/
 * If you don't send the current epoch, it will use the DEFAULT_TIME epoch.
 */
